...
?>
<div class="container mr-1 col-md-10" style="margin-top:-500px;">
    <div class="row">
        <div class="jumbotron">
            ...
            <?php
                if(isset($stuLogEmail)){
                    ...
                    c.course_author,c.course_original_price,c.course_price FROM courseorder AS co JOIN course AS c ON 
                    c.course_id=co.course_id WHERE co.stu_email = '$stuLogEmail'";
